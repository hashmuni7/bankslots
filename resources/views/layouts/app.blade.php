                                ...
                                <a href="#" data-toggle="dropdown" class="drop-btn">
                                    @if ($userProfilePhoto)
                                        <figure class="profile-picture">
                                            <img src="{{asset("storage/photos/$userProfilePhoto")}}" alt="" class="rounded-circle" data-lock-picture="{{asset("storage/photos/$userProfilePhoto")}}" />
                                        </figure>
                                    @endif
                                    
                                    <div class="profile-info">
                                        <span class="name text-primary">{{ Auth::user()->name }} </span>
